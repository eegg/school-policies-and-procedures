...
In the event that a child is not collected by an authorised adult at the end of a session/day, the setting puts into practice agreed procedures.
...
* Any collector of the child must be entered into the additional collector’s section of the enrolment form by a guardian of that child prior to collection.
