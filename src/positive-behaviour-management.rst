...
* ensuring all staff model good behaviour
...
have to intervene physically in order to prevent them from coming to harm.
...
#. Comfort any intense emotions in an age-appropriate way:
   ...
   * Verbal children: offer them an explanation and physical comfort if needed
...
+-------------------+---------------------------------------------+-----------------------------------------+-------------------------------------------+
| Cause of          | Explanation                                 | Signs of this cause                     | How to deal with it                       |
| behaviour         |                                             |                                         |                                           |
+===================+=============================================+=========================================+===========================================+
